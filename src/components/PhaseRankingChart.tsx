...
const CLASSIFICATION_COLORS: Record<Classification, { fill: string; stroke: string }> = {
  Strong:   { fill: '#dcfce7', stroke: '#166534' },
  Usable:   { fill: '#dbeafe', stroke: '#1e40af' },
  Risk:     { fill: '#fef3c7', stroke: '#92400e' },
    ...
    <div role="img" aria-label="Horizontal bar chart showing phase fit percentages">
      ...
      <ResponsiveContainer width="100%" height={280}>
        ...
        >
          ...
          <Tooltip
            formatter={(value: number, _name: string, props: { payload: { name: string; classification: string } }) =>
              [`${value}% — ${props.payload.classification}`, props.payload.name]
            }
          />
